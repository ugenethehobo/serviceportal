...
// ServicePortal toggles only the `dark` class on <html> (no `light` class).
...
function useResolvedTheme(themeProp?: "light" | "dark"): Theme {
  ...
  useEffect(() => {
    ...
    // Watch for document class changes (e.g. appearance settings toggling dark mode)
...
const Map = forwardRef<MapRef, MapProps>(function Map(
  ...
  // Re-measure when the container resizes (mobile layout / orientation changes).
  useEffect(() => {
