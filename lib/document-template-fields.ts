...
export const DOCUMENT_FIELD_DEFINITIONS: DocumentFieldDefinition[] = [
  { key: 'company.name', label: 'Company name', kinds: ['invoice', 'estimate'], group: 'Company' },
  {
    key: 'company.address',
  ...
  { key: 'client.name', label: 'Client name', kinds: ['invoice', 'estimate'], group: 'Client' },
  {
  ...
  { key: 'client.email', label: 'Client email', kinds: ['invoice', 'estimate'], group: 'Client' },
  { key: 'client.phone', label: 'Client phone', kinds: ['invoice', 'estimate'], group: 'Client' },
  { key: 'job.title', label: 'Job title', kinds: ['invoice'], group: 'Job' },
  { key: 'job.visit_date', label: 'Visit date', kinds: ['invoice'], group: 'Job' },
  {
    key: 'estimate.title',
  ...
  { key: 'footer.text', label: 'Footer note', kinds: ['invoice', 'estimate'], group: 'Footer' },
]
