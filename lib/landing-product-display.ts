 ...
 * Screenshots are authored at 2000×1200 (5:3).
 */
...
/** Centered mobile tour block — wide enough for side-by-side pair. */
export const LANDING_PRODUCT_MOBILE_CONTAINER_CLASS = 'mx-auto w-full max-w-2xl'
