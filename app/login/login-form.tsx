...
const LOGIN_ERROR_MESSAGES: Record<string, string> = {
  reset_link_expired: 'That password reset link has expired. Use Forgot password? to request a new one.',
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between gap-2">
                ...
                <Link
                  ...
                  className="text-xs font-medium text-primary hover:underline max-md:py-1"
                >
                  Forgot password?
                </Link>
              </div>
